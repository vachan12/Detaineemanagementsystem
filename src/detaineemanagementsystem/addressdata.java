...
public class addressdata extends javax.swing.JFrame {
    ...
    {
        try{
            //you need to delete everything and create again this happened to me twice i did the same 
        }
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addressdata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
